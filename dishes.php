...
<body>
    ...
    <div class="page-wrapper">
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Escolher
                            Restaurante</a></li>
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a
                            href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Escolha seu prato favorito</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                            <div class="image-wrap">
                                <figure>
                                    <?php echo '<img src="admin/Res_img/' . $rows['image'] . '" alt="Logotipo do Restaurante">'; ?>
                                </figure>
                            </div>
                        </div>
                ...
                ?>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <?php if ($item_total == 0) : ?>
                                <button class="btn theme-btn btn-lg disabled">Finalizar</button>
                                <?php else : ?>
                                        ...
                                        <form method="post"
                                            ...
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left"
                                                    href="#"><?php echo '<img src="admin/Res_img/dishes/' . $product['img'] . '" alt="Logotipo da Comida">'; ?></a>
                                            </div>

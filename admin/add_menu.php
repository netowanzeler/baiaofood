  ...
  if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '') {
    ...
    if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
      if ($fsize >= 1000000) {
        ...
        $sql = "INSERT INTO dishes(rs_id,title,slogan,price,img) VALUE('" . $_POST['res_name'] . "','" . $_POST['d_name'] . "','" . $_POST['about'] . "','" . $_POST['price'] . "','" . $fnew . "')";  // armazenar os dados enviados no banco de dados :imagens
        mysqli_query($db, $sql);
        move_uploaded_file($temp, $store);
        $success =   '<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																 Novo prato adicionado com sucesso.
															</div>';
      }
    } elseif ($extension == '') {
      $error =   '<div class="alert alert-danger alert-dismissible fade show">
        ...
        <div class="col-lg-12">
          <div class="card card-outline-primary">
            <div class="card-header">
              <h4 class="m-b-0 text-white">Adicionar Menu</h4>
            </div>
            <div class="card-body">
            ...
            <div class="form-actions">
              ...
              <a href="add_menu.php" class="btn btn-inverse">Cancelar</a>
            </div>
            </form>
          </div>
